...
namespace WebAppMVCProjectRainbow.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SubId,SubName,SubTeacher,SubAuthor")] Subject subject)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SubId,SubName,SubTeacher,SubAuthor")] Subject subject)
        {
            if (id != subject.SubId)
            {
                return NotFound();
        ...
        {
          return (_context.Subject?.Any(e => e.SubId == id)).GetValueOrDefault();
        }
    }
}
