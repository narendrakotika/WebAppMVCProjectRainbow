...
namespace WebAppMVCProjectRainbow.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CId,CName,CStrength,CTeacherName")] Classe classe)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CId,CName,CStrength,CTeacherName")] Classe classe)
        {
            if (id != classe.CId)
            {
                return NotFound();
        ...
        {
          return (_context.Classe?.Any(e => e.CId == id)).GetValueOrDefault();
        }
    }
}
